...
const AuthLayout = ({ children }) => {
  return (
    <div className="flex">
      ...
      <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-img bg-cover bg-no-repeat overflow-hidden p-8 relative">
        ...
        <img src={card2} alt="Card Image" className="w-64 absolute bottom-10 shadow-blue-400/15" />
      </div>
    </div>
  );
};
